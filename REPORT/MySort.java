...
class seperate extends Thread {
    ...
    public void run() 
    {
        try {
            ...
            Stream < String > chunks = Files.lines(Paths.get(MySort.Input_file)).skip(begin - 1).limit(lines).sorted(Comparator.naturalOrder());
...
public class MySort {
    ...
    public static void main(String[] args) throws Exception 
    {
        ...
        int i=1,no_of_threads = 1,lines = 10737418, linesPerFile = lines / no_of_threads;   
